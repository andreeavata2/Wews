      ...
      <div class="main-panel">
        ...
        <div class="setting-box">
          <div class="checkbox">
            ...
            <input type="checkbox" name="categorie1" value="Tehnologie" />
            Tehnologie<br /><br />
            <input type="checkbox" name="categorie2" value="Stiinta" />
            Stiinta<br /><br />
            <input type="checkbox" name="categorie3" value="Politica" />
            Politica<br /><br />
            <input type="checkbox" name="categorie4" value="Sport" checked />
            Sport<br /><br />
            <input type="checkbox" name="categorie5" value="Social" checked />
            Social<br /><br />
